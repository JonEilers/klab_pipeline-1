...
RECRUITED=16S_arc.recruited
COMPLETE=16S_arc.complete
AUTO1=16S_arc.auto1
REF=16S_arc.ref
...
trimal -automated1 -colnumbering -in $COMPLETE.fasta -out $AUTO1.pre_subset.afa > 16S_arc.pre.mask
...
$MARKCONSENSUS $COMPLETE.pruned.fasta 16S_arc.pre.mask 16S_arc.mask \
  --stockholm-out $COMPLETE.sto --masked-out $REF.fasta
rm -f 16S_arc.pre.mask
...
#raxmlHPC-PTHREADS-SSE3 -T 2 -m GTRGAMMA -n 16S_arc -s $REF.phymlAln
#STATS=RAxML_info.16S_arc
#TREE=RAxML_result.16S_arc
###     ;;
###   *)
...
/home/mclaugr4/software/bin/taxit taxtable -t $REF.ids_only -d $TAXDB > 16S_arc.taxonomy
...
###   -m 16S_arc.mask
# Reroot
/home/mclaugr4/software/bin/taxit reroot 16S_arc.refpkg

# Check the reference package
rppr check -c 16S_arc.refpkg

# Write the reference tree
rppr ref_tree -o 16S_arc-reftree.xml -c 16S_arc.refpkg
