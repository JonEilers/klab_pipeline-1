...
EUKTAXIDREX=/home/mclaugr4/bio/scripts/pplacer_pipeline_scripts/make_reference_packages/update_18S_taxid_regex.txt
LEN_THRESHOLD=0.2

RECRUITED=18S.recruited
COMPLETE=18S.complete
AUTO1=18S.auto1
REF=18S.ref
...
trimal -automated1 -colnumbering -in $COMPLETE.fasta -out $AUTO1.pre_subset.afa > 18S.pre.mask
...
$MARKCONSENSUS $COMPLETE.pruned.fasta 18S.pre.mask 18S.mask \
...
#raxmlHPC-PTHREADS-SSE3 -T 2 -m GTRGAMMA -n 18S -s $REF.phymlAln
#STATS=RAxML_info.18S
#TREE=RAxML_result.18S
###     ;;
###   *)
...
/home/mclaugr4/software/bin/taxit taxtable -t $REF.ids_only -d $TAXDB > 18S.taxonomy
...
###   -m 18S.mask
# Reroot
/home/mclaugr4/software/bin/taxit reroot 18S.refpkg

# Check the reference package
rppr check -c 18S.refpkg

# Write the reference tree
rppr ref_tree -o 18S-reftree.xml -c 18S.refpkg
